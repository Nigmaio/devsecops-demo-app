...
The hello-app image was built successfully.

The container was run successfully.

The expected message was displayed.

Running and stopped containers were inspected.

Git Security Exercise
A .gitignore file was configured.

Environment files and private keys were excluded.

A pre-commit hook was reviewed.

A custom Gitleaks rule was created.

A repository scan was completed.

Branch protection requirements were identified.

RBAC roles were reviewed.

CODEOWNERS was configured.

Dependabot configuration was added.